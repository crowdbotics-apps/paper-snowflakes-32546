...
## Project Structure
    ...
    ├── paper_snowflakes_32546  # Django project configurations
...
1. Clone this repo and `cd paper_snowflakes_32546`
...
2. Clone this repo and `cd paper_snowflakes_32546`
